...
export const metadata = {
  title: "Dry X - Moisture Control Solutions | Daran Global",
  ...
  openGraph: {
    title: "Dry X - Moisture Control Solutions",
    description: "Advanced moisture control solutions and silica gel products for industrial applications.",
    type: "website",
  },
};
