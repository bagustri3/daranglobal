...
export const metadata = {
  ...
  description: "Discover our diverse portfolio of industry-leading companies including Daran Furniture, Dry X, and Orminia. Each company excels in their respective markets.",
  openGraph: {
    title: "Our Companies - Daran Global",
...
export default function CompaniesPage() {
  ...
  const jsonLd = {
    ...
    "description": "Discover our diverse portfolio of industry-leading companies including Daran Furniture, Dry X, and Orminia.",
    "mainEntity": {
      "@type": "ItemList",
      "itemListElement": [
        {
  ...
  const companies = [
    ...
    {
      name: "Orminia",
      description: "Container house and steel construction specialists creating modern bungalows and residential solutions using repurposed shipping containers.",
      industry: "Container Houses & Steel Construction",
      image: "https://readdy.ai/api/search-image?query=Modern%20container%20house%20bungalow%20with%20steel%20construction%2C%20shipping%20container%20home%20with%20contemporary%20design%2C%20container%20architecture%20residential%20building%2C%20steel%20frame%20container%20house&width=800&height=600&seq=orminia&orientation=landscape",
      companySlug: "orminia"
    },
    {
      name: "FantechDrill",
        ...
        >
          <div className="container mx-auto px-6 text-center text-white">
            ...
            <p className="text-xl md:text-2xl max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-300">
              Discover our diverse portfolio of industry-leading companies, each excelling in their respective markets.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-300">
                Each company in our portfolio represents years of expertise, innovation, and commitment to delivering exceptional value to our clients.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto animate-fade-in-up animation-delay-300">
                Our portfolio companies share common values of excellence, innovation, and customer satisfaction.
              </p>
            </div>
