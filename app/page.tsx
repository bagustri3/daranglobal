...
export const metadata = {
  ...
  description:
    'Leading diversified corporate group delivering excellence in industrial equipment, custom furniture solutions, advanced moisture control systems, and contemporary architecture. We provide innovative, sustainable, and high-quality solutions for businesses, residences, and institutions, combining precision engineering, ergonomic design, environmental comfort, and modern architectural innovation to ensure efficiency, durability, and lasting impact.',
  keywords:
    'Diversified corporate group, Industrial equipment, Custom furniture, Moisture control systems, Contemporary architecture, Innovative machinery, Ergonomic furniture, Sustainable design',
  openGraph: {
    title: 'Daran Global – Equipment, Furniture & Architecture',
    description:
      'Leading diversified corporate group delivering excellence in industrial equipment, custom furniture solutions, advanced moisture control systems, and contemporary architecture.',
    type: 'website',
  },
};
...
const companies = [
  ...
  },
  {
    name: 'Orminia',
    description:
      'Contemporary architecture and construction services specializing in sustainable building solutions and innovative design concepts.',
    industry: 'Architecture & Construction',
    image:
      'https://readdy.ai/api/search-image?query=Modern%20contemporary%20architecture%20building%20with%20glass%20facade%2C%20sustainable%20construction%20materials%2C%20innovative%20design%20elements%2C%20green%20building%20technology%2C%20architectural%20excellence%2C%20professional%20construction%20site%2C%20modern%20urban%20development%2C%20sophisticated%20building%20design&width=800&height=600&seq=orminia&orientation=landscape',
    companySlug: 'orminia',
  },
  {
    name: 'Cocomodo',
    description:
      'Premium coconut-based products including desiccated coconut, coconut milk powder, and specialty ingredients for food industry applications worldwide.',
    industry: 'Coconut Products & Food Ingredients',
    image: 'https://assets.cdn.filesafe.space/ZienWw8SbdJEMwjcK9z0/media/651fe3303fadbf3b6365b88a.png',
...
export default function HomePage() {
  const jsonLd = {
    ...
    address: {
      '@type': 'PostalAddress',
      streetAddress:
        'CAMİ ŞERİF NEIGHBORHOOD 5225 ST. OTHELLO PLAZA NO: 18 INNER DOOR NO: 1 AKDENİZ/ MERSİN',
          ...
          <div className="container mx-auto px-6">
            <div className="text-center mb-16 animate-fade-in-up">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                A diversified portfolio of industry-leading companies, each excelling in their
                respective fields while sharing our commitment to quality and innovation.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in-left">
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  With decades of combined experience, our portfolio companies represent the
                  pinnacle of innovation and quality in their respective fields. From cutting-edge
                  furniture design to advanced moisture control solutions, we deliver excellence
                  that exceeds expectations.
                </p>
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center p-6 bg-gray-50 rounded-lg hover-lift">
                    <div className="text-3xl font-bold text-red-600 mb-2 animate-pulse-glow">
                      5+
                    </div>
          ...
          <div className="container mx-auto px-6 relative z-10">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-xl mb-8 leading-relaxed animate-fade-in-up animation-delay-300">
                Partner with Daran Global and experience the difference that comes from working with
