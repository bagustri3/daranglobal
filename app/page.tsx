  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed animate-fade-in-up animation-delay-300">
              Discover our diverse range of companies, each excelling in their respective industries 
              and contributing to our mission of building the future together.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-red-800 to-red-900 text-white relative overflow-hidden">
        ...
        <div className="absolute top-1/2 left-20 w-12 h-12 border border-white/20 rounded-full animate-float animation-delay-800"></div>
      </section>
    </div>
  );
}
